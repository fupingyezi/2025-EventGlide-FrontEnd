    ...
    <>
      <View className="postDetail">
        ...
        <View className="postDetail-content">
          <View className="postDetail-content-avatar">
            <Image
              src={Item.showImg[0]}
              className="postDetail-content-avatar-img"
            ...
            >
              {Item.showImg.map((item, index) => (
                <SwiperItem key={index} className="postDetail-content-avatar-swiper-item">
                  <Image
                    src={item}
                    className="postDetail-content-avatar-swiper-item-img"
                    mode="widthFix"
                  />
                </SwiperItem>
              ))}
          ...
          <View className="postDetail-content-desc">{Item.introduce || defaultDesc}</View>
          <View className="postDetail-content-timesite">昨天8：00 华中师范大学</View>
        </View>
